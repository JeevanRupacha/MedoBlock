...
const AccountCard = ({ description, title, imageSrc }: AccountCardProps) => {
  return (
    <div className='px-4'>
    <div className="transition ease-in-out delay-150 bg-blue-500 hover:scale-105 bg-homecard border-2 w-96 border-transparent shadow rounded-3xl cursor-pointer pt-6
